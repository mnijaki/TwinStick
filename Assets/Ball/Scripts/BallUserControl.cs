...
namespace UnityStandardAssets.Vehicles.Ball
{
  ...
  public class BallUserControl:MonoBehaviour
  {
    ...
    // Flag if draw debug gizmos for better understanding adding torque etc...
    [SerializeField]
    [Tooltip("Flag if draw debug gizmos for better understanding adding torque etc...")]
    ...
    private void OnDrawGizmos()
    {
      ...
      // If you want to see how normalization works change values of blue vector to (3,0,3) - same direction bo greater value).
